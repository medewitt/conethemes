...
#' @md
#' @export
set_cone_defaults <- function(style = "print") {

  # set deault theme to theme_urbn_*() --------------------------------------

  if (style == "print") {
    ggplot2::theme_set(theme_cone_print())
  } else if (style == "map") {
  ...
  ggplot2::update_geom_defaults("bar", list(fill = "#00a2b2"))
  ggplot2::update_geom_defaults("col", list(fill = "#00a2b2"))
  ggplot2::update_geom_defaults("point", list(colour = "#00a2b2"))
  ggplot2::update_geom_defaults("line", list(colour = "#00a2b2"))
  ggplot2::update_geom_defaults("step", list(colour = "#00a2b2"))
  ggplot2::update_geom_defaults("path", list(colour = "#00a2b2"))
  ggplot2::update_geom_defaults("boxplot", list(fill = "#00a2b2"))
  ggplot2::update_geom_defaults("density", list(fill = "#00a2b2"))
  ggplot2::update_geom_defaults("violin", list(fill = "#00a2b2"))

  # set default colors for monochromatic stats ------------------------------

  ggplot2::update_stat_defaults("count", list(fill = "#00a2b2"))
  ggplot2::update_stat_defaults("boxplot", list(fill = "#00a2b2"))
  ggplot2::update_stat_defaults("density", list(fill = "#00a2b2"))
  ggplot2::update_stat_defaults("ydensity", list(fill = "#00a2b2"))
